...
<html>
    ...
    //llamada al upload.php
            ...
            $("#userfile").change(function () {
                ...
                var file = $("#userfile")[0].files[0]; //get the File object 
                if (!file) {
                ...
                reader.onload = function (f) {
                    ...
                    //alert("Calculated SHA1:" + sha1_hash); //output result
                    sha = sha1_hash.toString();
                };
            ...
            $("#fileform").submit(function () {
                ...
                // var fileInput =$('input[type=file]')[0].files[0].name ;
